...
('نادى الانوار الرياضي', 'https://tlgyawtvchkuhjqalvzt.supabase.co/storage/v1/object/public/client/IMG_6786.PNG'),
('هيئه الرقابه النوناويه و الاشعاعيه', 'https://tlgyawtvchkuhjqalvzt.supabase.co/storage/v1/object/public/client/IMG_6785.PNG'),
('نادى العلا الرياضي', 'https://tlgyawtvchkuhjqalvzt.supabase.co/storage/v1/object/public/client/IMG_6784.PNG');
...
-- 8. Site Settings Data
INSERT INTO site_settings (key, value, description) VALUES
('phone', '055 062 2197', 'Contact phone number'),
('email', 'info@rsnalarabiya.com', 'Contact email address'),
('address_ar', 'حي الياسمين، الرياض، المملكة العربية السعودية', 'Physical address in Arabic'),
('address_en', 'Alyasmin District, Riyadh, Kingdom of Saudi Arabia', 'Physical address in English'),
